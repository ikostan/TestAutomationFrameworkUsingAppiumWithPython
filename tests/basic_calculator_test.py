...
from utils.screenshot import take_screen_shot
...
class TestBasicCalculatorCases(unittest.TestCase):
	...
	Check for the visibility of all buttons (0-9, DEL, CLR, . +,-,*,/,=) >>> All buttons must be visible
	"""
	...
	def tearDown(self) -> None:
		if self.driver.instance:
			print("Closing {} app...".format(self.driver.capabilities["appActivity"]))
