"""Web Element main methods/properties definition"""

#  Created by Egor Kostan.
#  GitHub: https://github.com/ikostan
#  LinkedIn: https://www.linkedin.com/in/egor-kostan/

from tests.android.web_app_tests.parabank_test.element_object_model.base_element import BaseElement
...
class Element(BaseElement):
	...
	It provides API to find the elements and take action on them like entering text into text boxes,
	clicking the buttons, etc.
