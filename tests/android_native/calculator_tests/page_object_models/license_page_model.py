...
from tests.android_native.calculator_tests.page_locators.license_page_locator import LicensePageLocator
...
class LicensePageModel:
	...
	def tap_arrow_btn(self):
		"""
		Tap Arrow (back to calc view) button
		:return:
		"""
		TouchAction(self.driver).tap(self._arrow_btn).wait(5).perform()
		print('Tap Arrow button')

		from tests.android_native.calculator_tests.page_object_models.calculator_page_model import CalculatorPageModel
		return CalculatorPageModel(self.driver)
